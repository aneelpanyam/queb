...
export const CROSSWORD_SEED_CONFIG: SetupConfiguration = {
  id: 'seed-config-crossword-puzzle-book',
  name: 'Crossword Puzzle Book for Kids',
  description:
    'Create a place-themed crossword puzzle book for children. Specify the destination, age group, and difficulty — the AI generates themed vocabulary with kid-friendly clues, then a layout algorithm builds each crossword grid. Export to KDP-ready PDF.',
  ...
  steps: [
    ...
    },
    {
      ...
      description: 'Define the age group and puzzle difficulty for the crossword puzzles.',
      fields: [
        {
          fieldId: 'empty-field',
          required: true,
        ...
        },
        {
          ...
          customSelectionMode: 'single',
          promptOverride:
            'List these difficulty levels for crossword puzzles:\n- Easy (short words, simple clues)\n- Medium (mixed word lengths, educational clues)\n- Hard (longer words, challenging clues)\n- Mixed (variety of easy, medium, and hard)',
        },
      ],
    },
  ],
  outputs: [
    { outputTypeId: 'crossword-puzzles' },
  ],
}

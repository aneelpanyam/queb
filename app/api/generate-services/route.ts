...
export async function POST(req: Request) {
  ...
  const result = await generateText({
    ...
    prompt: `For the "${industry}" industry, list 15-20 typical services that organizations in this industry commonly provide. Be specific and practical. Return only the service names as strings.
